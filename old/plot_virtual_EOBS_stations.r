...
#####
setEPS()
postscript(paste0(my_figs_dir,"/virtual_rain-gauges_EOBS_loc.eps"))
plot(pointCoordinates, main=paste0("Virtual E-OBS weather stations\n","Total number=",length(pointCoordinates)), add=FALSE)
my_col <- terrain.colors(15)
plot(elevation_crop, add=TRUE, breaks = c(5,50,100,200,300,400,500,750,1000,1500,2000,3000,4000), col=my_col, legend=FALSE)
...
setEPS()
postscript(paste0(my_figs_dir,"/virtual_rain-gauges_EOBS_dist.eps"))
