...
my_anag_file     <- paste0("DATA/points025_moloch_extent.csv")
my_anag_file     <- paste0("DATA/ARCIS/Arcis_Stazioni_Pluviometriche.csv")
...
# Now plot
setEPS()
postscript(paste0(my_figs_dir,"/mean_monthly_clim_1981-2019"), width=7, height=4.5)
...
my_min           <- 40
my_max           <- 140
plot(eobs_mon_mean,type="l", col="black", lwd=4, ylab="Average monthly precipitation [mm]", xlab="Month", xaxt="n", ylim=c(my_min,my_max), main="1981-2019")
...
hydroGOF::KGE(era5_mon_mean, eobs_mon_mean)
hydroGOF::KGE(molo_mon_mean, eobs_mon_mean)
hydroGOF::KGE(bola_mon_mean, eobs_mon_mean)
...
# Now plot
setEPS()
postscript(paste0(my_figs_dir,"/mean_monthly_clim_1981-2015"), width=7, height=4.5)
...
my_max           <- 140
my_months        <- c("Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec")
plot(arci_mon_mean,type="l", col="black", lwd=4, ylab="Average monthly precipitation [mm]", xlab="Month", xaxt="n", ylim=c(my_min,my_max), main="1981-2015")
axis(1, at=seq(1,12),labels=my_months, col.axis="black", las=2)
lines(era5_mon_mean, col="red", lwd=2.5)
points(era5_mon_mean, col="red", lwd=2.5, pch=19, cex=1.5)
lines(molo_mon_mean, col="orange", lwd=2.5)
...
hydroGOF::KGE(era5_mon_mean, arci_mon_mean)
hydroGOF::KGE(molo_mon_mean, arci_mon_mean)
hydroGOF::KGE(bola_mon_mean, arci_mon_mean)


#########################################
# Load data 2001-2016 (GRIPHO)
file_grip        <- paste0("DATA/GRIPHO/tp/gripho-v2-10km_mon_tp_AVG2001-2016.nc")
...
# Now plot
setEPS()
postscript(paste0(my_figs_dir,"/mean_monthly_clim_2001-2016.eps"), width=7, height=4.5)
...
my_max           <- 160
my_months        <- c("Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec")
plot(grip_mon_mean,type="l", col="black", lwd=4, ylab="Average monthly precipitation [mm]", xlab="Month", xaxt="n", ylim=c(my_min,my_max), main="2001-2016")
axis(1, at=seq(1,12),labels=my_months, col.axis="black", las=2)
lines(era5_mon_mean, col="red", lwd=2.5)
points(era5_mon_mean, col="red", lwd=2.5, pch=19, cex=1.5)
lines(molo_mon_mean, col="orange", lwd=2.5)
...
# KGE with the hydroGOF package
hydroGOF::KGE(era5_mon_mean, grip_mon_mean)
hydroGOF::KGE(molo_mon_mean, grip_mon_mean)
hydroGOF::KGE(bola_mon_mean, grip_mon_mean)
