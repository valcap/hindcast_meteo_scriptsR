...
my_vector_bola  <- NULL
my_vector_molo  <- NULL
vec_thres       <- c(700,900,1100,1400,1600,1800)
...
###
  ...
  file_eobs   <- paste0("DATA/",obse_dataset,"/tp/gripho-v2-3km_year_tp_",my_year,".nc")
...
setEPS()
file_taylor_eps <- paste0(my_figs_dir,"/tp_PerfDiag_vs_",obse_dataset,".eps")
...
for (i in seq(1,6)) {  
  ...
  performance.diagram(main = paste0(my_lab,' Threshold = ',thres,' mm/year'), cex.main=0.99, cex.lab=1.1, cex.axis=0.99)
