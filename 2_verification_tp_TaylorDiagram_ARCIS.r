...
# Open raster files
obse_dataset<- 'ARCIS'
file_eobs   <- paste0("DATA/ARCIS/tp/ARCIS_year_tp_AVG1981-2015.nc")
file_era5   <- paste0("DATA/ERA5-Land/tp/ERA5-Land_year_tp_AVG1981-2015.nc")
file_molo   <- paste0("DATA/MOLOCH/tp/moloch_year_tp_AVG1981-2015.nc")
file_bola   <- paste0("DATA/BOLAM/tp/bolam_year_tp_AVG1981-2015.nc")
