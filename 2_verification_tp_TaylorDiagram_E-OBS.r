...
###
# Open raster files
file_eobs   <- paste0("DATA/E-OBS/tp/E-OBS_year_tp_AVG1981-2019.nc")
file_era5   <- paste0("DATA/ERA5-Land/tp/ERA5-Land_year_tp_AVG1981-2019.nc")
file_molo   <- paste0("DATA/MOLOCH/tp/moloch_year_tp_AVG1981-2019.nc")
file_bola   <- paste0("DATA/BOLAM/tp/bolam_year_tp_AVG1981-2019.nc")
...
setEPS()
file_taylor_eps <- paste0(my_figs_dir,"/tp_TaylorDiag_vs_EOBS_norm",TD_normal,".eps")
