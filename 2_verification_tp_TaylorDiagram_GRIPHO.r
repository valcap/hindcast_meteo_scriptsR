...
# Open raster files
obse_dataset<- 'GRIPHO'
file_eobs   <- paste0("DATA/",obse_dataset,"/tp/",obse_dataset,"_year_tp_AVG2001-2016.nc")
file_era5   <- paste0("DATA/ERA5-Land/tp/ERA5-Land_year_tp_AVG2001-2016.nc")
file_molo   <- paste0("DATA/MOLOCH/tp/moloch_year_tp_AVG2001-2016.nc")
file_bola   <- paste0("DATA/BOLAM/tp/bolam_year_tp_AVG2001-2016.nc")
...
era5_values <- as.data.frame(extract(era5_resam*sf_era5, pointCoordinates))
...
print(paste(obse_dataset,my_sd,sep=";"))
...
setEPS()
file_taylor_eps <- paste0(my_figs_dir,"/tp_TaylorDiag_vs_",obse_dataset,"_norm",TD_normal,".eps")
